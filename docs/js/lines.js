const lines = {
  ua: {
    ...
    mainSubtitle: `ТОВ «ФК «АКЦЕНТ ФІНАНС» здійснює діяльність фінансової компанії в частині надання коштів та банківських металів у кредит, надає послуги з фінансового лізингу та послуги з факторингу.`,
    ...
    commonInfoText2: `Відомості про власника істотної участі та кінцевого бенефіціарного власника (контролера):
Громадянка України Вишневська Інга Олександрівна - 100% частка у статутному капіталі.`,
    commonInfoText3: "Директор: Єлізарʼєв Сергій Володимирович.",
...
Наглядова рада товариства - відсутня.`,
    regBtn: "Свідоцтво",
    strBtn: "Структура властності (архів)",
    strBtnCurrent: "Поточна структура властності від 10.02.2026",
    servicesTitle: "Наші послуги",
    servicesText:
      "Головною метою ТОВ «ФК «АКЦЕНТ ФІНАНС» є надання повного спектру фінансових послуг, таких як: надання коштів та банківських металів у кредит, надання послуг з факторингу, надання послуг з фінансового лізингу. Фінансові послуги ТОВ «ФК «АКЦЕНТ ФІНАНС» надає виключно субʼєктам господарювання. ТОВ «ФК «АКЦЕНТ ФІНАНС» не надає кредити фізичним особам – споживачам. Наші зусилля спрямовані на розвиток та поширення фінансових послуг в Україні. ",
    ...
    address: ` Україна, 61052, Харківська область, місто Харків, вулиця Дмитрівська, будинок 15, приміщення 1а `,
    workTime__title: "Графік роботи:",
    work__time:
      "Понеділок-п'ятниця з 10:00 до 18:00(без обіду). Субота, неділя - вихідні дні.",
...
мінімальний обсяг інформації та/або порядок її надання не встановлений спеціальними законами.`,
    ...
    protectedTitle: `Підтримка споживачів та інших осіб, що належать до захищеної категорії`,
    protectedText1: `Під час врегулювання простроченої заборгованості у період дії воєнного стану в Україні та протягом 90 днів з дня його припинення кредитодавець зобов'язаний не взаємодіяти за власною ініціативою зі споживачем, який повідомив про свою належність до захищеної категорії.`,
    protectedSubtitle: `Захищеними категоріями є:`,
    protectedList1: `а) військовослужбовці Збройних Сил України, інших утворених відповідно до законів України військових формувань та правоохоронних органів спеціального призначення, Державної спеціальної служби транспорту, Державної служби спеціального зв'язку та захисту інформації України, які проходять військову службу на території України;`,
    protectedList2: `б) військовослужбовці, які стали особами з інвалідністю внаслідок захворювання, пов'язаного з проходженням військової служби, чи внаслідок захворювання після звільнення їх з військової служби, пов'язаного з проходженням військової служби;`,
    protectedList3: `в) члени сімей військовослужбовців, які загинули, померли чи пропали безвісти;`,
    protectedList4: `г) особи, які перебувають у полоні, особи, з якими втрачено зв'язок, особи, зниклі безвісти.`,
    protectedText2: `Також забороняється взаємодіяти за власною ініціативою з близькими особами споживача, який належить до захищеної категорії, його представником (крім представника, який не є близькою особою такого споживача).`,
    protectedText3Bold1: `Споживач, який належить до захищеної категорії`,
    protectedText3Mid: ` та має бажання на період дії воєнного стану в Україні (та протягом 90 днів з дня його припинення або скасування) припинити взаємодію з особами з захищеної категорії, його близькі особи `,
    protectedText3Bold2: `повідомляють кредитодавця про це та про належність споживача до захищеної категорії`,
    protectedText3End: `. Для цього потрібно надіслати електронне звернення на `,
    protectedText3Addr: ` або зателефонувати за номером `,
    protectedText3AddrEnd: ` та/або подати письмове звернення на адресу: Україна, 61052, Харківська область, місто Харків, вулиця Дмитрівська, будинок 15, приміщення 1а (з наданням копій підтвердних документів про належність споживача до захищеної категорії).`,
  ...
  ru: {
    ...
    mainSubtitle: `ООО «ФК «АКЦЕНТ ФИНАНС» осуществляет деятельность финансовой компании по предоставлению средств и банковских металлов в кредит, предоставляет услуги по финансовому лизингу и услуги по факторингу.`,
    ...
    commonInfoText2: `Сведения о владельце существенного участия и конечном бенефициарном владельце (контролере): Гражданка Украины Вишневская Инга Александровна - 100% доля в уставном капитале.`,
    commonInfoText3: "Директор: Елизарев Сергей Владимирович.",
    ...
    strBtn: "Структура собственности (архив)",
    strBtnCurrent: "Текущая cтруктура собственности от 10.02.2026",
    regBtn: "Свидетельство",
    servicesTitle: "Наши услуги",
    servicesText:
      " Главной целью ООО «ФК «АКЦЕНТ ФИНАНС» является предоставление полного спектра финансовых услуг, таких как: предоставление средств и банковских металлов в кредит, предоставление услуг по факторингу, предоставление услуг по финансовому лизингу. Финансовые услуги ООО «ФК «АКЦЕНТ ФИНАНС» предоставляет исключительно хозяйствующим субъектам. ООО «ФК «АКЦЕНТ ФИНАНС» не предоставляет кредиты физическим лицам – потребителям. Наши усилия направлены на развитие и распространение финансовых услуг в Украине. ",
    ...
    address: ` Украина, 61052, Харьковская область, город Харьков, улица Дмитриевская, дом 15, помещение 1а `,
    workTime__title: "График работы:",
    work__time:
      "Понедельник-пятница с 10:00 до 18:00 (без обеда). Суббота, воскресенье – выходные дни.",
    ...
    protectedTitle: `Поддержка потребителей и других лиц, относящихся к защищённой категории`,
    protectedText1: `В период урегулирования просроченной задолженности в период действия военного положения на Украине и в течение 90 дней со дня его прекращения кредитодатель обязан не взаимодействовать по собственной инициативе с потребителем, сообщившим о своей принадлежности к защищённой категории.`,
    protectedSubtitle: `Защищёнными категориями являются:`,
    protectedList1: `а) военнослужащие Вооружённых Сил Украины, других созданных в соответствии с законами Украины воинских формирований и правоохранительных органов специального назначения, Государственной специальной службы транспорта, Государственной службы специальной связи и защиты информации Украины, проходящие военную службу на территории Украины;`,
    protectedList2: `б) военнослужащие, ставшие лицами с инвалидностью вследствие заболевания, связанного с прохождением военной службы, либо вследствие заболевания после увольнения их с военной службы, связанного с прохождением военной службы;`,
    protectedList3: `в) члены семей военнослужащих, погибших, умерших или пропавших без вести;`,
    protectedList4: `г) лица, находящиеся в плену, лица, с которыми утрачена связь, лица, пропавшие без вести.`,
    protectedText2: `Также запрещается взаимодействовать по собственной инициативе с близкими лицами потребителя, относящегося к защищённой категории, его представителем (кроме представителя, который не является близким лицом такого потребителя).`,
    protectedText3Bold1: `Потребитель, относящийся к защищённой категории`,
    protectedText3Mid: ` и желающий в период действия военного положения на Украине (и в течение 90 дней со дня его прекращения или отмены) прекратить взаимодействие с лицами из защищённой категории, его близкие лица `,
    protectedText3Bold2: `уведомляют кредитодателя об этом и о принадлежности потребителя к защищённой категории`,
    protectedText3End: `. Для этого необходимо направить электронное обращение на `,
    protectedText3Addr: ` или позвонить по номеру `,
    protectedText3AddrEnd: ` и/или подать письменное обращение по адресу: Украина, 61052, Харьковская область, город Харьков, улица Дмитриевская, дом 15, помещение 1а (с предоставлением копий подтверждающих документов о принадлежности потребителя к защищённой категории).`,
  },
};
